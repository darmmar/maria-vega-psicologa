...
export const contactPageCollection: Collection = {
  name: "contactPage",
  label: "Contacto · Página de contacto",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          description: "Por defecto: «Nombre».",
        },
        {
          type: "string",
          name: "namePlaceholder",
          label: "Placeholder del campo Nombre",
          description: "Por defecto: «Tu nombre».",
        },
        {
          type: "string",
          name: "emailLabel",
          label: "Etiqueta del campo Email",
          description: "Por defecto: «Email».",
        },
        {
          type: "string",
          name: "emailPlaceholder",
          label: "Placeholder del campo Email",
          description: "Por defecto: «tu@email.com».",
        },
        {
          type: "string",
          name: "messageLabel",
          label: "Etiqueta del campo Mensaje",
          description: "Por defecto: «Mensaje».",
        },
        {
          type: "string",
          name: "messagePlaceholder",
          label: "Placeholder del campo Mensaje",
          description: "Por defecto: «¿En qué puedo ayudarte?».",
        },
        {
          type: "string",
          name: "privacyConsentText",
          label: "Texto de consentimiento de privacidad",
          description: "Texto junto a la casilla de verificación de privacidad.",
          ui: { component: "textarea" },
        },
        {
          type: "string",
